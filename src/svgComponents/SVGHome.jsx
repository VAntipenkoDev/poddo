...
const SVGHome = ({ fill }) => (
  ...
  >
    <defs>
      <linearGradient
        id="nav-link-button-gradient"
        x1="0%"
        y1="0%"
        x2="100%"
        y2="100%"
      >
        <stop offset="0%" style={{ stopColor: '#7139CF', stopOpacity: 1 }} />
        <stop offset="100%" style={{ stopColor: '#632BCD', stopOpacity: 1 }} />
      </linearGradient>
    </defs>
    <path
